...
namespace FT_PurchasingPortal.Web {
    ...
    public partial class FT_PurchasingPortalAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private FT_PurchasingPortal.Module.FT_PurchasingPortalModule module3;
        private FT_PurchasingPortal.Module.Web.FT_PurchasingPortalAspNetModule module4;
        ...
        static FT_PurchasingPortalAspNetApplication() {
        ...
        #endregion
        public FT_PurchasingPortalAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void FT_PurchasingPortalAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
