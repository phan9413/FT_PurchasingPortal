<%@ Control Language="C#" CodeBehind="DefaultVerticalTemplateContent1.ascx.cs" ClassName="DefaultVerticalTemplateContent1" Inherits="FT_PurchasingPortal.Web.DefaultVerticalTemplateContent1" %>
