...
namespace FT_PurchasingPortal.Module.BusinessObjects
{
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        [Appearance("PurchaseDeliveryDetail", Enabled = false, Criteria = "not (DocStatus.CurrDocStatus in (0, 2, 4, 7))")]
    ...
    #region details
    [Persistent("OPRN1")]
    [RuleCriteria("PurchaseDeliveryDetailSaveRule", DefaultContexts.Save, "IsBatchNumberValid", "Batch Number is not valid")]
    [RuleCriteria("PurchaseDeliveryDetailSaveRule2", DefaultContexts.Save, "IsSerialValid", "Quantity must be 1 when managed by serial")]
