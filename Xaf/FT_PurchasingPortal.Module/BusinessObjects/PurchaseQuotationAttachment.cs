...
namespace FT_PurchasingPortal.Module.BusinessObjects
{
    ...
    [XafDisplayName("Purchase Quotation Attachment")]
    // Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    public class PurchaseQuotationAttachment : FileAttachmentBase
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public PurchaseQuotationAttachment(Session session)
            : base(session)
        {
        }
        ...
        public PurchaseQuotation PurchaseQuotation
        {
            ...
            set { SetPropertyValue("PurchaseQuotation", ref _PurchaseQuotation, value); }
        }
