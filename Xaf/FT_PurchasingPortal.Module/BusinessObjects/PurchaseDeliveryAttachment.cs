...
namespace FT_PurchasingPortal.Module.BusinessObjects
{
    ...
    [XafDisplayName("Purchase Delivery Attachment")]
    // Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    public class PurchaseDeliveryAttachment : FileAttachmentBase
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public PurchaseDeliveryAttachment(Session session)
            : base(session)
        {
        }
        ...
        public PurchaseDelivery PurchaseDelivery
        {
            ...
            set { SetPropertyValue("PurchaseDelivery", ref _PurchaseDelivery, value); }
        }
