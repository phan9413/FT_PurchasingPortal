...
namespace XamarinGRN.ViewModels
{
    public class ChoosePOViewModel : BaseViewModel
    {
        ...
        private ObservableCollection<PurchaseDelivery> polist;
        private IEnumerable<vwWarehouses> iwhslist;
        private IEnumerable<PurchaseDelivery> ipolist;
        ...
        private PurchaseDelivery _SelectedPO;
        public PurchaseDelivery SelectedPO
        {
        ...
        public async Task getPO()
        {
            ...
            using (var client = new HttpClientWapi())
            {
                ...
                if (client.isSuccessStatusCode)
                {
                    ...
                    ipolist = JsonConvert.DeserializeObject<IEnumerable<PurchaseDelivery>>(content);
                    polist = new ObservableCollection<PurchaseDelivery>(ipolist);
        ...
        {
            text = text.ToUpper();
            polist = new ObservableCollection<PurchaseDelivery>(ipolist.Where(pp => pp.DocNo.ToUpper().Contains(text)));
            page._polist.ItemsSource = polist;
        }
